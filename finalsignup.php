...
<link rel="stylesheet" href="signup_form_styles.css">
...
<!-- Student signup form-->
      <form id="student-signup-form" class="collapse" action="<?php echo htmlspecialchars( $_SERVER['PHP_SELF'] ); ?>" method="post">
        ...
        <div class="form-col collapse.show firstPage">
        ...
        <div class="form-group collapse.show firstPage">
        ...
        <div class="form-group collapse thirdPage col-12">
        ...
        <div class="form-col collapse thirdPage col-12">
        ...
        <div class="collapse fourthPage col-12">
          <div class="form-row">  
            <div class="form-group col-12">
...
<!-- Teacher signup form-->
      ...
      <form id="teacher-signup-form" class="collapse" action="<?php echo htmlspecialchars( $_SERVER['PHP_SELF'] ); ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group collapse fourthPage col-12">
          <label for="inputAddress">Address</label>
        ...
        <div class="form-col collapse fourthPage col-12">
        ...
        <div class="collapse fifthPage col-12">
          <div class="form-row">          
            <div class="form-group col-12">
              <label for="DOB">Date of Birth</label>
...
<!-- This button is to submit the form to the datebase--> 
  ...
  <script src ="signup_form_script.js"></script>
