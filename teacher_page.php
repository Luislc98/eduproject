        ...
        <div class="wrapper" id="page-background">
            ...
            <div>
                ...
                <div class ="container-fluid">
                    ...
                    <div style="background-color: orange;" class="row justify-content-center align-items-center">
                        <div class="col">
                            <span>One column</span>
                        </div>
                    </div>
                    ...
                    <div style="background-color: green;" class="row justify-content-center align-items-center">
                        <div class="col">
                            <span>One of two columns</span>
                        </div>
                        <div class="col">
